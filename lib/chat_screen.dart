...
class _ChatScreenState extends State<ChatScreen> with TickerProviderStateMixin {
  ...
  Future<void> _sendMessage() async {
    ...
    if (answers.isEmpty) {
      ...
      // منبع را از اولین پاسخ می‌گیریم (در صورت چند سوالی، ساده‌سازی)
  ...
  // حالا یک Map شامل answer و source برمی‌گرداند
  Future<Map<String, String>?> _processSingleQuestion(String question) async {
    ...
    // ۳. تلاش برای دریافت پاسخ از بک‌اند
    if (_isBackendOnline) {
      ...
      if (backendResponse != null) {
        ...
        // خطا در اتصال: یک بار تلاش مجدد برای بررسی سرور
        _checkBackendStatus();
        ...
        children: [
          ...
          Column(
            children: [
              ...
              _buildConnectivityBanner(), // <-- نوار وضعیت جدید
              Expanded(
        ...
        children: [
          Column(
            ...
            children: [
              ...
              // نمایش منبع پاسخ (برای پیام‌های غیر کاربر)
...
class ChatMessage {
  ...
  String? reaction;
  String? source; // 'backend', 'local', etc.
